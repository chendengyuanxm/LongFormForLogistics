 ...
 */
public class AMapNaviActivity extends CheckPermissionsActivity implements AMapNaviListener, AMapNaviViewListener{
    private static final String TAG = AMapNaviActivity.class.getSimpleName();

    private AMapNaviView mAMapNaviView;
    private AMapNavi mAMapNavi;

    private NaviLatLng mEndLatlng = new NaviLatLng(25.48469, 119.183743); //new NaviLatLng(25.48469, 119.183743)
    private NaviLatLng mStartLatlng = new NaviLatLng(24.48469, 118.183743); //new NaviLatLng(24.48469, 118.183743)
...
//        try {
//            mStartLatlng = (NaviLatLng) getIntent().getExtras().get("startLatlng");
//            mEndLatlng = (NaviLatLng) getIntent().getExtras().get("endLatlng");
//        }catch (Exception e) {
//            ToastUtil.show(this, "未设置导航起点或终点，导航退出！");
//            finish();
//        }
    }
    ...
    private void startNavi() {
        if (mStartLatlng == null || mEndLatlng == null) return;

        Log.d(TAG, "开始导航>>> from:" + mStartLatlng + " to:" + mEndLatlng);
...
//        mAMapNavi.stopNavi();
    ...
    public void onInitNaviFailure() {
        Toast.makeText(this, "initNavi navi Failed", Toast.LENGTH_SHORT).show();
    }
